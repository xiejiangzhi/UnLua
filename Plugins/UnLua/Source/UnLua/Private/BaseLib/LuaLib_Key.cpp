...
BEGIN_EXPORT_CLASS(EKeys)
    ...
    ADD_STATIC_FUNCTION_EX("GetAllKeys", void, GetAllKeys, TArray<FKey>&)
    ADD_STATIC_FUNCTION_EX("IsModifierKey", bool, IsModifierKey, FKey)
    ADD_STATIC_FUNCTION_EX("IsGamepadKey", bool, IsModifierKey, FKey)
    ADD_STATIC_FUNCTION_EX("IsAxis", bool, IsModifierKey, FKey)
    ADD_STATIC_FUNCTION_EX("GetGamepadDisplayName", FText, GetGamepadDisplayName, FKey)
